...
<div class="admin-form">
    <?= $this->Form->create('Government', [
        ...
        <div class="form-field__list form-field__list--textarea <?php echo $this->Form->error('birthday') ? 'form-field__list--error' : '' ;?>">
            ...
            <div class="form-field__input-wrapper">
                <input name="data[Government][birthday]" type="date" class="form-field__input" value="<?= isset($captain['Government']['birthday']) ? $captain['Government']['birthday'] : "" ?>">
        ...
        <div class="form-field__list form-field__list--textarea">
            ...
            <div class="form-field__input-wrapper">
                ...
                <div class="form-field__image-wrapper">
                    <?php if(!empty($captain['Government']['image'])): ?>
                        <img src="<?= $captain['Government']['image'] ?>" class="form-field__image">
                    <?php else: ?>
