        ...
        <table class="admin-table__wrapper">
            ...
            <tbody>
                <tr class="admin-table__row">
                    <td class="admin-table__result">Denmark</td>
                    <td class="admin-table__result">11-01-1976</td>
                    <td class="admin-table__result">Example Message</td>
                    <td class="admin-table__result">Otosan</td>
